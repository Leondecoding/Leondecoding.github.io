...
// Works dataset (titles both languages)
const works = [
  // Filled in from placeholders generated in /assets/images
];

// This array is injected dynamically based on the available images
for (let i=1;i<=12;i++){
...
const state = {
  lang: "en",           // default English per request
  filter: "all",
  query: "",
  visible: [],
  cursor: 0,            // for lightbox navigation within current visible set
};
