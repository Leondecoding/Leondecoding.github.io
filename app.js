...
// v15: enforce 4-up grid by adding classes to containers that directly hold multiple figures
(function(){
  function enforce(){
    var v = document.querySelector('#view');
    if(!v) return;
    var els = v.querySelectorAll('div, section, main, article');
    els.forEach(function(el){
      try{
        var figs = el.querySelectorAll(':scope > figure');
