...
async function boot(){
  try{
    ...
    // Fallback minimal translations so页面可用
    state.translations = { en: { nav: {
      home:"HOME", ourStory:"OUR STORY", blog:"BLOG",
      originalArt:"ORIGINAL ART", artPrint:"ART PRINTS",
      greetingCard:"GREETING CARDS", contact:"CONTACT",
      language:"中文", login:"Login"
    }}};
  }
...
async function renderStory(){
  ...
  const form = sec.querySelector("#newsletterForm");
